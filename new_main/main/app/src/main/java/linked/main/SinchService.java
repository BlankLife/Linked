...
public class SinchService extends Service {
    private static final String APP_KEY = "52f37bcc-5c85-4124-9f00-b4e1bf6bc696";
    private static final String APP_SECRET = "wu5VaCwnb0KyyXazW6JnXw==";
    ...
    public class SinchServiceInterface extends Binder {
        public boolean isStarted() { return SinchService.this.isStarted(); }
    ...
    private class MySinchClientListener implements SinchClientListener {
        ...
        @Override
        public void onClientStopped(SinchClient client) {Log.d(TAG, "SinchClient stopped");
        }
